...
void Start()
{
    ...
    StartCoroutine(InstantiateWithDelay(SferaLenta2, new Vector3(-0.94f, 2.81f, -0.65f), 2f, 1));
    StartCoroutine(InstantiateWithDelay(SferaLenta3, new Vector3(3.17f, 2.81f, -0.68f), 2f, 1));
    StartCoroutine(InstantiateWithDelay(SferaLenta4, new Vector3(6.72f, 2.81f, -0.6f), 2f, 1));
